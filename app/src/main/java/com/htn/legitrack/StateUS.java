...
// Modified, courtesy of Austin C, https://github.com/AustinC/UnitedStates
...
public enum StateUS {
    ...
    StateUS(String unabbreviated, String ANSIabbreviation, String ISOabbreviation) {
     ...
     */
    public static StateUS parse(String input) {
        if (null == input) {
            return null;
        }
        input = input.trim();
        for (StateUS state : values()) {
